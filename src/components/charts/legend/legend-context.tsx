...
export interface LegendItemData {
  ...
  /** Item color */
  color: string;
  /** Optional secondary text (e.g. UAH below USD in rankings) */
  subtext?: string;
  /** Optional rank badge (medal emoji or number) */
  rank?: string;
  /** True when `rank` is a top-3 medal emoji */
  isMedal?: boolean;
  /** Optional leading emoji (avatar) */
  emoji?: string;
  /** Optional item id (e.g. worker id for navigation) */
  id?: string;
}
